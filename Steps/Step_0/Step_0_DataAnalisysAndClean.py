...
from Sensori.Drone import Drone
    ...
    for scenario in scenari:
        ...
        if 'Alvira' in sensori or 'All' in sensori:
            ...
            '''La funzione "clean_data" per Alvira si occupa di:
                ...
                - Creazione del file ripulito nella DIR '1-DataCleaned/Scenario_SCENARIO/[1]_ALVIRA_data_cleaned_SCENARIO'.csv'''
        ...
        if 'Arcus' in sensori or 'All' in sensori:
            ...
            La funzione "clean_data" per Arcus si occupa di:
                ...
                - Creazione del file ripulito nella DIR '1-DataCleaned/Scenario_SCENARIO/[1]_ARCUS_data_cleaned_SCENARIO'.csv
            '''
            arcs.clean_data()
        ...
        if 'Diana' in sensori or 'All' in sensori:
            ...
            '''
                    La funzione "clean_data" per Diana si occupa di:
                        ...
                        - Creazione del file ripulito nella DIR '1-DataCleaned/Scenario_SCENARIO/[1]_DIANA_data_cleaned_SCENARIO'.csv
                    '''
            diana.clean_data()
        ...
        if 'Venus' in sensori or 'All' in sensori:
            ...
            '''
                            La funzione "clean_data" per Venus si occupa di:
                                ...
                                - Creazione del file ripulito nella DIR '1-DataCleaned/Scenario_SCENARIO/[1]_VENUS_data_cleaned_SCENARIO'.csv
                            '''
            venus.clean_data()
...
def print_feature_missing_rate(df):
    for col in df.columns:
